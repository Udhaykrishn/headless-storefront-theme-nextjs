      ...
      <main className="flex-1">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-12 lg:py-24 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between mb-24 p-12 lg:p-16 bg-white/40 backdrop-blur-3xl rounded-[4rem] border border-white/60 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.08)] gap-12">
            <div>
              <span className="text-indigo-400 text-[10px] font-black uppercase tracking-[0.6em] mb-4 block">
                Current Selection
              </span>
              ...
              <p className="text-slate-500 mt-12 font-bold uppercase tracking-[0.3em] text-[10px]">
                {isEmpty
                  ? "Zero assets curated"
                  : `${cart.lines.edges.length} premium pieces staged`}
              </p>
            </div>
            {!isEmpty && (
              <Link
                href="/shop"
                className="group text-[10px] font-black uppercase tracking-[0.3em] bg-indigo-950 text-white px-12 py-6 rounded-full hover:bg-black transition-all shadow-2xl skew-x-[-12deg]"
              >
          ...
          {isEmpty || !cart ? (
            <div className="bg-white/30 backdrop-blur-[50px] rounded-[5rem] p-16 lg:p-48 text-center border border-white/60 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-5xl font-black mb-8 uppercase tracking-tighter text-indigo-950 italic">
                  The vault is open
                </h2>
                <p className="text-slate-500 mb-16 max-w-lg mx-auto leading-relaxed font-bold uppercase tracking-[0.2em] text-[11px] opacity-80 italic">
                  Your curated archive remains unoccupied. Begin your journey
                  through our latest material manifestations.
                </p>
                <Link href="/shop">
                  <Button
                    size="lg"
                    className="rounded-full px-16 h-24 text-[10px] font-black uppercase tracking-[0.4em] shadow-2xl bg-indigo-600 hover:scale-[1.05] transition-all border-none"
                  >
                    Discovery Protocol
                  </Button>
                </Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
              ...
              <div className="lg:col-span-8 space-y-12">
                <div className="space-y-12">
                  {cart.lines.edges.map((edge: any) => {
                    ...
                    return (
                      <div
                        key={line.id}
                        className="group relative flex flex-col md:flex-row gap-12 p-10 rounded-[4rem] bg-white/40 backdrop-blur-3xl border border-white/60 shadow-xl hover:bg-white/50 transition-all duration-700"
                      >
                          ...
                          <div className="flex justify-between items-start mb-10">
                            <div className="max-w-[70%]">
                              ...
                              <div className="flex flex-wrap gap-4 mt-8">
                                <span className="text-[9px] font-black text-indigo-400 uppercase tracking-[0.2em] bg-white/60 px-5 py-2 rounded-full border border-white/60 shadow-sm">
                                  {merchandise.title}
                                </span>
                                <span className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] bg-white/60 px-5 py-2 rounded-full border border-white/60 shadow-sm">
                ...
                <div className="pt-32 relative">
                  <div className="flex items-center justify-between mb-16">
                    <h2 className="text-4xl font-black uppercase tracking-tighter italic text-indigo-950 underline decoration-indigo-200 decoration-8 underline-offset-8">
                      Complementary Units
                    </h2>
                    <span className="text-[9px] font-black uppercase tracking-[0.5em] text-indigo-400">
                      Archive Suggestions
                    </span>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="space-y-8 group cursor-pointer relative"
                      >
                        <div className="aspect-[3/4] rounded-[3.5rem] overflow-hidden bg-white/20 backdrop-blur-3xl border-2 border-white/60 shadow-xl group-hover:scale-105 transition-all duration-[1s]">
                          ...
                          <div className="absolute inset-x-0 bottom-0 p-8 bg-white/40 backdrop-blur-xl translate-y-full group-hover:translate-y-0 transition-transform duration-700 border-t border-white/60">
                            <Button className="w-full bg-indigo-600 text-[9px] font-black uppercase tracking-[0.3em] rounded-full h-12 shadow-2xl">
                              Deploy Asset
                            </Button>
                          </div>
                        </div>
                        <div className="px-6">
                          <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-950 mb-2">
                            Refined Attachment // {i}
                          </h4>
                          <p className="text-xs font-black text-indigo-400 uppercase tracking-[0.2em] italic">
                            $75.00
                          </p>
                        </div>
                      </div>
              ...
              <div className="lg:col-span-4">
                <div className="bg-white/40 backdrop-blur-[60px] rounded-[4rem] shadow-[0_50px_100px_-20px_rgba(79,70,229,0.15)] border-2 border-white/80 p-12 lg:p-16 sticky top-32 overflow-hidden transition-all duration-700 hover:shadow-[0_80px_150px_-30px_rgba(79,70,229,0.25)]">
                  ...
                  <h2 className="relative text-5xl font-black mb-16 uppercase tracking-tighter text-indigo-950 italic leading-none">
                    Voucher
                  </h2>
                  ...
                  <div className="space-y-10 mb-16 relative">
                    <div className="flex justify-between items-center bg-white/60 p-8 rounded-[2rem] border border-white/80 shadow-inner group">
                      <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 group-hover:text-indigo-400 transition-colors">
                        Net Valuation
                      </span>
                    ...
                    <div className="pt-6 px-4">
                      <span className="block text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-6">
                        Total Investment
                      </span>
                  ...
                  <Button
                    asChild
                    className="w-full h-28 text-[11px] font-black uppercase tracking-[0.4em] rounded-[2.5rem] shadow-[0_30px_60px_-12px_rgba(79,70,229,0.5)] hover:shadow-none hover:scale-[0.98] transition-all bg-indigo-600 border-none relative overflow-hidden group/checkout"
                    size="lg"
                  >
                    <a
                      href={cart.checkoutUrl}
                      className="flex items-center justify-between px-12 relative z-10"
                    >
                  ...
                  <div className="mt-16 grid grid-cols-2 gap-6 px-4">
                    <div className="flex flex-col gap-4 items-center bg-white/50 p-6 rounded-[2rem] border border-white/80 group">
                      ...
                      <span className="text-[8px] font-black uppercase tracking-[0.4em] text-slate-500 whitespace-nowrap">
